...
class Home extends CI_Controller {
	...
	// new home view //
	public function bindex($page='uni_home') {
		header("Access-Control-Allow-Origin: *");
		$this->load->view('frontend/templates/header_with_slider');
	...
	// new table instead of dramarkkhi_sharj() //
	public function Table() {
		...
		$data = $this->get_filters_data($session['email'], 2);	// 1) storages 2) mtgroups 3) materials 4) partners
		$data['title'] = 'Table';
		$data["dataT"] = [];

		if($this->input->get()) {
			$data["dataT"] = $this->get_sales();

			// $this->load->view('frontend/templates/header', $data);
			// $this->load->view('frontend/table.php', $data);
			// $this->load->view('frontend/templates/footer_simple' , $data);
		...
		// if($this->input->get()){
		// 	$data["dataT"] = $this->get_sales();	// filtered data, after pushing search button//
		// 	// echo "<pre>";
		// 	// print_r($this->get_sales());die;
		// 	// $this->load->view('frontend/templates/header', $data);
		// 	// $this->load->view('frontend/table.php', $data);
		// 	// $this->load->view('frontend/templates/footer_simple' , $data);
		// 	return $this->load->view('frontend/table.php', $data);
		// }
	}
